...
const Contact = () => {
  return (
    <div className="md:p-10 p-3 pb-1 md:px-14 flex flex-col  font-manrope bg-primary h-full" >
      ...
      <div className="w-full my-5 md:h-screen bg-white p-10 rounded-2xl mt-10">
        <h1 className="text-5xl  font-heading font-semibold py-5 text-text m-5">Contact us</h1>
        <div className="flex flex-col md:flex-row gap-5 h-full ">

          <div className="md:w-1/2 border-[7px] h-2/3 rounded-xl shadow border-white">
            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3829.1260441096338!2d80.40884821957403!3d16.31650271396272!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTbCsDE5JzAxLjgiTiA4MMKwMjQnMzMuMiJF!5e0!3m2!1sen!2sin!4v1726322982382!5m2!1sen!2sin" className="w-full h-full" loading="lazy" />
          </div>
